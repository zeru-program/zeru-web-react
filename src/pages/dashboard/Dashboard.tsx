                    ...
                    <tbody id="project-body">
                        {result.map((val: Project) => (
                            <tr key={val.id}>
                                ...
                                <td>
                                    <input type="text" value={val.tech} />
                                </td>
                                <td>
                                    <input type="text" value={val.display} />
                                </td>
                                <td>
                    ...
                    <tbody id="portofolio-body">
                        {result.map((val: Porto) => (
                            <tr key={val.id}>
                                ...
                                <td>
                                    {/*<button style={{padding:"10px",marginRight:"8px", background:"yellow"}} onClick={editPorto('{val.id}', this)}>EDIT</button><button style={{padding:"10px", background:"red"}} onClick={deletePorto('{val.id}')}>DELETE</bbutton*/}
                                </td>
                            </tr>
                        ))}
                    </tbody>
        ...
        fetch(urlDb + "sourceCode.json")
            ...
            .then(data => {
                ...
                fetch(urlDb + "sourceCode.json", {
                    ...
                    if (res.ok) {
                        alert(
                            "berhasil membuat source code, jangan lupa membuat file source nya."
                        );
                        location.reload();
                    }
                });
    ...
    return (
        <div className="todo">
            ...
            <form
                ...
                className="d-flex gap-2 flex-column"
            >
                <label htmlFor="">File image banner</label>
                <input type="file" onInput={handleIptFile} id="titlePorto" />
                ...
                <label htmlFor="">Url file source code</label>
                    ...
                    <tbody id="portofolio-body">
                        {result.map(val => (
                            <tr key={val.id}>
                                ...
                                <td>{val.url}</td>
                                <td>
                                    {/*<button style={{padding:"10px",marginRight:"8px", background:"yellow"}} onClick={editPorto('{val.id}', this)}>EDIT</button><button style={{padding:"10px", background:"red"}} onClick={deletePorto('{val.id}')}>DELETE</button>*/}
                                </td>
                            </tr>
                        ))}
                    </tbody>
