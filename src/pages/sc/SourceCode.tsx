    ...
    return (
        <>
            <main className="py-5 mt-5">
                <h1 className="text-center fw-bold">My source code.</h1>
                <div className="mt-3 gap-4 justify-content-center d-flex flex-wrap container">
                    {result.map((data, index) => (
                        <div
                            key={index}
                            className="d-flex overflow-hidden flex-column align-items-center rounded-3 rounded"
                            style={{
                                width: "350px",
                                height: "300px",
                                borderRadius: "5px",
                            ...
                            onClick={() => handleClickBox(`${data.title}`)}
                        >
                            <img
                                src={data.banner ? data.banner : "/bgcode.jpg"}
                                alt="source code default image"
                                style={{ width: "100%" }}
                            />
