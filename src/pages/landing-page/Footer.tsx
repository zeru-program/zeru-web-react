 ...
 <footer className="">
    <div className="container-footer">
        ...
        <div className="isi-f pb-3">
            ...
            <p className="sub-footer">
                <a href="https://github.com/zeru-program/">Github</a>
            </p>
            <p className="sub-footer">
                <a href="https://wa.me/6289526333265">WhatsApp</a>
            </p>
            <p className="sub-footer">
                <a href="https://www.instagram.com/zerr.ace?r">Instagram</a>
            </p>
            <p className="sub-footer">
                <a href="mailto:zeruprogram@gmail.com?subject=HireYou">Email</a>
            </p>
        </div>
    </div>
    <label className="copyright mt-5"
        >Copyright ©{currentYear} zeru program, all rights reserved. version web app
        3.0.4</label
    >
</footer>
{/* footer end */}
