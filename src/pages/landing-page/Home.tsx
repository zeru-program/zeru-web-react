...
const Homepage: React.FC<HomepageProps> = ({
  ...
  <div className="fill-home">
    ...
    <div className={`${conImgTalkTrClass} ccon-img-tal`} style={{ animation: `${conImgTalkTr}` }}>
     <img src="whatsapp.png" onClick={() => window.location.href = 'https://api.whatsapp.com/send?phone=6287774487198'} className="img-talk-social" alt="" />
    <img src="instagram.png" onClick={() => window.location.href = 'https://www.instagram.com/zerr.ace/'} className="img-talk-social" alt="" />
    <img src="gmail.png" onClick={() => window.location.href = 'mailto:zeruprogram@gmail.com?subject=HiZeru!'} className="img-talk-social" alt="" />
    </div>
  </div>
    ...
    <div className="contact-information">
      ...
      <div className="isi-info-contact">
        <div className="c1-contact" style={{paddingLeft:"5px"}}>
          <i className="img-talk-social bi bi-github" />
