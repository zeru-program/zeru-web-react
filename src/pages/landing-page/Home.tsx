...
const HeroSection = () => (
  <section style={{ width: '100%', height: 'auto' }} className="justify-content-center align-items-center px-3 gap-5 py-5 section-hero-home" id="home">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeSmrjGNbQ6dkkk1KkpWBKkmJJqNEhvDgOjw&usqp=CAU" className="rounded-5" style={{ width: '200px' }} alt="" data-aos="fadeInTop" />
    <div className="div-text-hero-home" data-aos="fadeIn">
      <p className="m-0">#justdoit.</p>
      <h2 className="m-0">I'm <span className="m-0" style={{ color: '#8B76F7' }}>Justine</span></h2>
      <h2 className="m-0">Fullstack web developer</h2>
      <p className="m-0 text-secondary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora autem tempore maxime officia itaque labore, nisi et tenetur nostrum possimus.</p>
...
const AboutSection = () => (
  <section className="m-0 text-center py-4 mt-3 px-5" id="about">
    <h2 className="m-0" style={{ color: '#8B76F7' }} data-aos="fadeInLeft">- About me -</h2>
...
const SpecializingSection = () => (
  <section className="m-0 text-center mt-5 px-5 py-4">
    <h2 className="m-0" style={{ color: '#8B76F7' }} data-aos="fadeIn">- Spealizing in -</h2>
    <div className="m-0 justify-content-center mt-2 d-flex w-100 animate-spealizing gap-4" style={{ flexDirection: 'row' }} data-aos="fadeIn">
      <div className="btn d-flex justify-content-center align-items-center flex-column" style={{ width: '250px', height: '250px', minWidth: '250px', background: 'rgb(175,160,248,.15)' }}>
        <h2 style={{ color: '#8B76F7', margin: 0 }}>Web developer</h2>
        <p className="m-0 text-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio, placeat.</p>
      </div>
      <div className="btn d-flex justify-content-center align-items-center flex-column" style={{ width: '250px', height: '250px', minWidth: '250px', background: 'rgb(175,160,248,.15)' }}>
        <h2 style={{ color: '#8B76F7', margin: 0 }}>Design grafis</h2>
        <p className="m-0 text-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio, placeat.</p>
      </div>
      <div className="btn d-flex justify-content-center align-items-center flex-column" style={{ width: '250px', height: '250px', minWidth: '250px', background: 'rgb(175,160,248,.15)' }}>
        <h2 style={{ color: '#8B76F7', margin: 0 }}>ML/Ai Engineer</h2>
        <p className="m-0 text-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio, placeat.</p>
      </div>
    </div>
  </section>
...
const PortfolioSection = () => {
  ...
  <section className="m-0 text-center mt-5 px-2 py-4" id="portofolio">
    <h2 className="m-0" style={{ color: '#8B76F7' }} data-aos="fadeIn">- Portofolio & project -</h2>
    ...
    <div className="d-flex mt-4 justify-content-center flex-wrap gap-3">
      {
        Array.isArray(projects) && projects.map(project => (
          <div className="box-project overflow-hidden" key={project.title} onClick={() => window.open(project.url)} data-aos="fadeIn">
            ...
            <h4 className="mx-2 mt-2">{project.title}</h4>
...
const ContactSection = () => {
  ...
  <section className="m-0 mt-5 px-5 py-4" id="contact" data-aos="fadeIn">
    <h2 className="m-0 text-center" style={{ color: '#8B76F7' }}>- Contact me -</h2>
